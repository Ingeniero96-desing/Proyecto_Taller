...
$routes->get('consultas/editar/(:num)', 'Consulta_controller::editar_consulta/$1');
$routes->post('consultas/editar/(:num)', 'Consulta_controller::actualizar_consulta/$1');
$routes->get('consultas/eliminar/(:num)', 'Consulta_controller::eliminar_consulta/$1');
$routes->post('consultas/responder/(:num)', 'Consulta_controller::responder_consulta/$1');
